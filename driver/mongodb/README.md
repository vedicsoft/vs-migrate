...
For a detailed example see: [sample_mongodb_migrator.go](https://github.com/vedicsoft/vs-migrate/blob/master/driver/mongodb/example/sample_mongdb_migrator.go)

```go
package my_mongo_db_migrator

import (
  "github.com/vedicsoft/vs-migrate/driver/mongodb"
  "github.com/vedicsoft/vs-migrate/driver/mongodb/gomethods"
  "gopkg.in/mgo.v2"
)
